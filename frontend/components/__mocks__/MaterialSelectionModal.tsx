...
export const MaterialSelectionModal = jest.fn(({ isOpen, onClose, onSelect }) => {
  ...
  return (
    <div data-testid="material-selection-modal">
      ...
      <button data-testid="select-first-material-btn" onClick={() => onSelect({ id: 'M-1', name: 'Material A', description: 'Description A', categoryId: 'CAT-1', unitCost: 10, unitWeight: 1, components: [], unit: 'kg', diameterValue: 10, diameterUnit: 'mm', lengthValue: 100, lengthUnit: 'mm', widthValue: 50, widthUnit: 'mm' })}>Material A</button>
