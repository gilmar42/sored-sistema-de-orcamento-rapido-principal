  ...
  return (
    <div className="min-h-screen bg-background dark:bg-slate-900 flex flex-col justify-center items-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4 mb-4 text-sm text-blue-700 dark:text-blue-200">
          <p className="font-semibold">Teste grátis de 5 dias</p>
          <p>Acesso completo e ilimitado para validar o sistema antes da cobrança automática da assinatura.</p>
          <p className="mt-1">Você pode cancelar a qualquer momento antes do fim do período gratuito, sem cobranças.</p>
        </div>
        <div className="bg-surface dark:bg-slate-800 shadow-xl rounded-lg px-8 pt-6 pb-8 mb-4">
          ...
          <form onSubmit={handleSubmit}>
            ...
            {(error || authError) && <p className="text-red-500 text-xs italic mb-4">{error || authError}</p>}
