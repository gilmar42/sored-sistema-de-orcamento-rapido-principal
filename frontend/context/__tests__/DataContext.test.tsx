...
// Mock apiService to prevent import.meta.env syntax from being evaluated
...
describe('DataContext', () => {
  ...
  it('should load existing data from local storage', () => {
    const storedMaterials = [{ id: 'M-1', name: 'Material 1', unitCost: 10, unit: 'kg' }];
  ...
  const testUser = { id: 'U-1', email: 'test@example.com', tenantId: 'T-1' };
    ...
    const newMaterial = { id: 'M-2', name: 'Material 2', unitCost: 20, unit: 'kg' };
    act(() => {
