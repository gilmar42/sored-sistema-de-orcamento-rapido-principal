...
export const MaterialFormModal: React.FC<MaterialFormModalProps> = ({ isOpen, onClose, onSave, materialToEdit }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 p-4">
      <div role="dialog" className="bg-surface rounded-lg shadow-xl w-full max-w-lg max-h-[90vh] flex flex-col">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col flex-grow overflow-hidden" data-testid="material-form">
          <div className="p-4 overflow-y-auto flex-grow">
            ...
            <div className="mb-4">
              <label htmlFor="name" className="block text-sm font-medium text-textSecondary mb-1">Nome do Material</label>
              <input
                type="text"
                id="name"
                className="w-full px-3 py-2 border border-border rounded-md bg-background text-textPrimary focus:outline-none focus:ring-2 focus:ring-primary"
                value={name}
            ...
            <div className="mb-4">
              <label htmlFor="description" className="block text-sm font-medium text-textSecondary mb-1">Descrição (Opcional)</label>
              <textarea
                id="description"
                rows={3}
                className="w-full px-3 py-2 border border-border rounded-md bg-background text-textPrimary focus:outline-none focus:ring-2 focus:ring-primary"
            ...
            <div className="mb-4">
              <label htmlFor="unitWeight" className="block text-sm font-medium text-textSecondary mb-1">Peso Unitário</label>
              <div className="flex gap-2">
                ...
                <select
                  ...
                  className="w-24 px-3 py-2 border border-border rounded-md bg-background text-textPrimary focus:outline-none focus:ring-2 focus:ring-primary"
                  required
                >
            ...
            <div className="mb-4">
              <label htmlFor="unitCost" className="block text-sm font-medium text-textSecondary mb-1">Custo Unitário (R$)</label>
              <input
                type="number"
                id="unitCost"
                step="0.01"
            ...
            <div className="mt-6">
              <h4 className="text-lg font-semibold text-textPrimary mb-3">Componentes do Material</h4>
              {/* Single 'Adicionar Componente' button is rendered after the components list */}
              {components.map((component, index) => (
                <div key={component.id} className="mb-4 p-3 border border-border rounded-md">
                  ...
                  <div className="mb-2">
                    <label htmlFor={`component-name-${component.id}`} className="block text-sm font-medium text-textSecondary mb-1">Nome do Componente</label>
                    <input
                      type="text"
                  ...
                  <div className="mb-2">
                    <label htmlFor={`component-unitWeight-${component.id}`} className="block text-sm font-medium text-textSecondary mb-1">Peso Unitário</label>
                    <input
                      type="number"
                  ...
                  <div className="mb-2">
                    <label htmlFor={`component-unit-${component.id}`} className="block text-sm font-medium text-textSecondary mb-1">Unidade de Peso</label>
                    <select
                  ...
                  <div className="mb-2">
                    <label htmlFor={`component-unitCost-${component.id}`} className="block text-sm font-medium text-textSecondary mb-1">Custo Unitário (R$)</label>
                    <input
                      type="number"
                  ...
                  <div className="mb-2">
                    <label htmlFor={`component-length-${component.id}`} className="block text-sm font-medium text-textSecondary mb-1">Comprimento</label>
                    <input
                  ...
                  <div className="mb-2">
                    <label htmlFor={`component-length-unit-${component.id}`} className="block text-sm font-medium text-textSecondary mb-1">Unidade de Comprimento</label>
                    <select
                  ...
                  <div className="mb-2">
                    <label htmlFor={`component-diameter-${component.id}`} className="block text-sm font-medium text-textSecondary mb-1">Diâmetro</label>
                    <input
                      type="text" // Changed to text to allow for "1/2\"" input
                  ...
                  <div className="mb-2">
                    <label htmlFor={`component-diameter-unit-${component.id}`} className="block text-sm font-medium text-textSecondary mb-1">Unidade de Diâmetro</label>
                    <select
                  ...
                  <div className="mb-2">
                    <label htmlFor={`component-width-${component.id}`} className="block text-sm font-medium text-textSecondary mb-1">Largura</label>
                    <input
                      type="text" // Changed to text to allow for "1/2\"" input
                  ...
                  <div className="mb-2">
                    <label htmlFor={`component-width-unit-${component.id}`} className="block text-sm font-medium text-textSecondary mb-1">Unidade de Largura</label>
                    <select
          ...
          <div className="p-4 border-t border-surface-light flex justify-end space-x-2">
            <button
              type="button"
              onClick={onClose}
